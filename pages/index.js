...
const Home = () => {
    ...
    const [receiver, setReceiver] = useState("GuFstnu8NZXhJvavmLybvAYqXEoZZYQEws6F2Lb5BLNA");
    ...
    const [Pregunta, stePreguntas] = useState(null);
    ...
    const signIn = async () => {
        ...
        toast.success("Your wallet is connect");
    ...
    const sendTransaction = async () => {
        try {
            ...
            toast.success("Apuesta realizada con");
        ...
        <div className="h-screen bg-black">
            <div className="flex flex-col  w-auto h-auto  bg-black">
                <div className="flex flex-col py-10 place-items-center justify-center">
                    ...
                    {/* <h1 className="text-6xl font-bold pb-10 text-emerald-300">
                        BattleCoin
                        <img src="/miimagen.jpg" alt="Logo" />
                    </h1> */}
                ...
                {publicKey ? (
                        <div className="flex flex-col py-10 place-items-center justify-center">
                            ...
                            <br />
                            <h1 className="text-2xl font-bold text-white">
                                Amount of own SOL:  {balance} SOL
                            </h1>
                            <br />
                            <h1 className="text-2xl  text-white">               
                                Amount of SOL you want to bet:
                            </h1>
                            <input
